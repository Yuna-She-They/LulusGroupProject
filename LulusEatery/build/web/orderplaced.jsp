<%-- 
    ...
    Created on : Apr 26, 2019, 7:20:50 PM
...
<html>
	<head>
		...
		<link rel="stylesheet" href="CSS_SCSS/OrderPlacedStyle.css" />
				...
				<article id="orderplaced">
					...
					<h1>Thank you for your order, ${placedcustomer.fname}!</h1>
                                        ...
                                        <table>
                                            ...
                                            <c:forEach var="item" items="${placedcart}">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        Total: <fmt:formatNumber value="${placedtotal}" type="currency"/>
                                                    </td>
                                                </tr>
                                        </table>
